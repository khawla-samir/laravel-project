            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="{{URL('insertCustomer')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="name">Customer Message</label>
                            <input type="text" class="form-control" id="customer" name="msg">
                        </div>
                    ...
                    <a class="btn btn-primary mg-b-20" href="/showCustomers">Show Customers</a>
                </div>
            </div>
